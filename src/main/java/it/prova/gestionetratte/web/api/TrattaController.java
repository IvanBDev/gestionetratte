...
import it.prova.gestionetratte.web.api.exception.TrattaAncoraAttivaOConclusa;
...
public class TrattaController {
	...
	public void delete(@PathVariable(required = true) Long id) {
		...
		if(tratta.getStato() != Stato.ANNULLATA)
			throw new TrattaAncoraAttivaOConclusa("La tratta che si vuole eliminare e' ancora"+ tratta.getStato());
